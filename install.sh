#!/usr/bin/env sh
# Universal installer for secretsweep. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/secretsweep.git"
echo "Installing secretsweep ..."
...
echo "Done. Run: secretsweep --help"
